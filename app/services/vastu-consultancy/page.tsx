...
import { Building, ShoppingBag, Briefcase, Home, BedDouble, HeartHandshake, Factory, BarChart, TrendingUp } from 'lucide-react';
...
export default function VastuConsultancyPage() {
  ...
  return (
    <main className="min-h-screen">
      <div className="relative bg-gradient-to-br from-amber-50 to-rose-50 dark:from-gray-900 dark:to-gray-800 overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-32 pb-16 relative z-10">
          ...
          >
            ...
            >
              Transform your living and working spaces through scientific Vastu principles for enhanced harmony, prosperity, and wellbeing.
            </motion.p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              Vastu Shastra is an ancient science of architecture and space design that harmonizes the five elements to create balanced environments:
            </p>
          </motion.div>
          
          <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Health & Happiness", desc: "Improvement in physical and mental well-being." },
              { title: "Wealth & Prosperity", desc: "Financial stability and increased opportunities." },
              { title: "Peace & Harmony", desc: "Enhanced relationships and tranquility." },
              { title: "Growth & Success", desc: "Success and advancement in personal and professional life." }
            ].map((item, i) => (
              <motion.div 
                key={i} 
      ...
      <section id="services" className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              Transform your home into a sanctuary of positive energy and prosperity:
            </p>
          </motion.div>
          ...
          >
            {residentialAreas.map((area, i) => (
              <motion.div 
                key={i}
                className="p-8 bg-rose-50 dark:bg-gray-800 border border-rose-100 dark:border-gray-700 rounded-xl transition-all duration-300"
                variants={cardVariants}
                whileHover="hover"
              >
                <motion.div 
      ...
      <section className="py-16 bg-white dark:bg-gray-800/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              Optimize your business spaces for maximum productivity, growth, and prosperity:
            </p>
          </motion.div>
      ...
      {/* Residential Benefits Section - NEW */}
      <section className="py-16 bg-white dark:bg-gray-800/50">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div 
            ...
            >
              ...
              >
                {[
                  {
                    title: "Enhanced Family Harmony",
                    desc: "Proper energy flow reduces conflicts and promotes peaceful coexistence."
                  },
                  {
                    title: "Improved Health & Wellbeing",
                    desc: "Balanced energy supports better physical and mental health for all family members."
                  },
                  {
                    title: "Financial Prosperity",
                    desc: "Correct placement of wealth areas attracts financial opportunities and abundance."
                  },
                  {
                    title: "Better Sleep Quality",
                    desc: "Optimized bedroom layouts promote restful sleep and rejuvenation."
                  }
                ].map((item, i) => (
                  <motion.li 
                    key={i} 
            ...
            <motion.div 
              className="order-2 lg:order-2 relative w-full h-[400px] lg:h-[500px] overflow-hidden rounded-2xl"
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
            >
              <motion.div
                className="absolute inset-0 bg-gradient-to-r from-rose-500/20 to-amber-500/20 z-10"
                whileHover={{ opacity: 0 }}
                transition={{ duration: 0.5 }}
              />
              <motion.img
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
              We follow a systematic approach to transform your spaces:
            </p>
          </motion.div>
              ...
              {[
                {
                  ...
                  desc: "We conduct a thorough assessment of your space and understand your specific needs and challenges."
                },
                {
                  title: "Energy Evaluation",
                  desc: "Our experts analyze your space layout, energy flow, and identify imbalances affecting your life."
                },
                {
                  title: "Customized Solutions",
                  desc: "We develop tailored recommendations that align with your goals and minimize disruption to existing structures."
                },
                {
        ...
        <div className="container mx-auto text-center px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl mx-auto mt-6 mb-10 max-w-3xl text-white/90">
              Take the first step towards creating a harmonious environment that supports your wellbeing and prosperity.
            </p>
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
